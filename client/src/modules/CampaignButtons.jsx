...
export default function CampaignButtons({ 
  ...
  const toggleEditCampaignModal = () => setEditCampaignModal(!editCampaignModal);
      ...
      {images.map((image) => (
        <div className='ajs-container'>
          <div>
            ...
            }} width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            }} width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
